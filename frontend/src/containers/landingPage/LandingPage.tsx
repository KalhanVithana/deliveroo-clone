...
const LandingPage: FC<LandingPageProps> = () => {
  ...
  const isLoading = useSelector((state: any) => state.foodMenu.isLoading);
  ...
  return (
    <>
      ...
      />
      <SubNavBarComponent
        isScroller={scrollPosition > 400 ? true : false}
      ...
      {memoizedFetchData && memoizedFetchData.length ? (
        <>
          <div className="landing-section2">
            ...
            <Typography
              className="landing-section2-des2"
              variant="h6"
              gutterBottom
            >
          ...
          <div className="middle-section">
            <div>
              <FooodItemComponent
                initialCards={memoizedFetchData[0].foodItems}
              />
              <FoodList
